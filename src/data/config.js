export const personalityTypes = {
  emotionalTelepatia: {
    ...
    emoji: '🔮💭',
    description: 'Ты обладаешь редким даром понимать невысказанные мысли и чувства других людей.',
  ...
  magneticAttraction: {
    ...
    emoji: '✨🧲',
    description: 'У тебя есть особое обаяние, которое притягивает людей.',
  ...
  relationshipAlchemy: {
    ...
    emoji: '⚗️❤️',
    description: 'Ты умеешь превращать обычные моменты в золотые воспоминания.',
  ...
  soulHealer: {
    name: 'Целитель душ',
    emoji: '🌱💫',
    description: 'Твоё присутствие приносит покой и ясность.',
  ...
  wisdomKeeper: {
    ...
    emoji: '📚✨',
    description: 'Ты видишь глубже поверхности и находишь смысл там, где другие видят только хаос.',
  ...
  specialMomentCreator: {
    ...
    emoji: '✨🎭',
    description: 'Ты умеешь создавать моменты волшебства в повседневности.',
  ...
  impossibilityMaster: {
    ...
    emoji: '🌈🔧',
    description: 'Ты видишь возможности там, где другие опускают руки.',
